...
public class Material {
    ...
    public Material(Integer id, Integer id_material, Integer id_dobavca, String percent, String photo_before, String photo_after_impact_test, String photo_reverse) {
        this.id = id;
